...
def info():
    ...
    print("Ver: 1.7.1 beta")
    print("""
    =================================================
    -Script melhorado
    -Removido opção 2 de busca CPF,EMAIL TELEFONE
    -Adicionado % para visualizar o processo de busca
    =================================================
        """)
...
plataforma = input("Escolha uma opção: ")
print("""
...
if plataforma == "1":
    ...
    facebook_busca(termo)

elif plataforma == "3":
    instagram(termo)

elif plataforma == "4":
    busca_por_termo(termo)
